  ...
  render() {
    ...
    return (
      ...
      <div className="container" style={styles.page}>
        ...
        <h3 className="text-center"><a href="https://medium.com/@ericflo/why-i-made-an-open-source-model-zoo-d9bda255b7d6#.f0tqkr4c7">Why I built an open source model zoo</a></h3>
